...
```mermaid
graph LR
    F1["dynobuffers/.github/workflows/go.yml"]
    F2["airs-bp3/.github/workflows/ci.yml"]
    F3["airs-bp3/.github/workflows/nightly_tests.yml"]
    F4["airc-backoffice2/.github/workflows/ci.yml"]
    F5["airc-ticket-layouts/.github/workflows/short_go.yml"]
    F6["web-portals/.github/workflows/ci.yml"]
    ...
    F17["web-portals/.github/workflows/cp.yml"]
    F18["web-portals/.github/workflows/cronecprelease.yml"]
    F19["voedger/.github/workflows/cp.yml"]
    F20["voedger/.github/workflows/ci_amazon.yml"]
    F21["voedger/.github/workflows/ci_cas.yml"]
    F22["airs-bp3/.github/workflows/rc.yml"]
    F23["airc-backoffice2/.github/workflows/rc.yml"]
    F24["web-portals/.github/workflows/rc.yml"]
    F25["ci-action/.github/workflows/cp.yml"]
    F26["ci-action/.github/workflows/rc.yml"]
    F27["ci-action/.github/workflows/ci_pr.yml"]
    F28["ci-action/.github/workflows/ci.yml"]
    F29["airs-bp3/.github/workflows/close_cprelease.yml"]
    F30["ci-action/.github/workflows/create_issue.yml"]
    F31["airs-bp3/.github/workflows/cd_go.yml"]
    F32["airc-backoffice2/.github/workflows/cd.yml"]
    F33["web-portals/.github/workflows/cd-portal.yml"]
    F34["airc-web-pos/.github/workflows/cd.yml"]
    F35["ci-action/checkout-and-setup-go/action.yml"]
    F36["voedger/.github/workflows/merge.yml"]
    F37["voedger/.github/workflows/linkIssue.yml"]
    F38["voedger/.github/workflows/unlinkIssue.yml"]
    F39["airs-bp3/.github/workflows/update_config_sync.yml"]
    F40["airc-backoffice2/.github/workflows/cdd.yml"]
    F41[".github/workflows/ci.yml"]
    F42[".github/workflows/ci_pr.yml"]
    F43[".github/workflows/cp.yml"]
    F44[".github/workflows/create_issue.yml"]
    F45[".github/workflows/rc.yml"]
    F46["checkout-and-setup-go/action.yml"]
    F47["scripts/add-issue-commit.sh"]
    F48["scripts/cancelworkflow.sh"]
    F49["scripts/checkPR.sh"]
    F50["scripts/check_copyright.sh"]
    F51["scripts/check_gomod.sh"]
    F52["scripts/check_sh_header.sh"]
    F53["scripts/ci_go.sh"]
    F54["scripts/close-issue.sh"]
    F55["scripts/cp.sh"]
    F56["scripts/createissue.sh"]
    F57["scripts/deleteDockerImages.sh"]
    F58["scripts/detect-go-version.sh"]
    F59["scripts/detect_language.sh"]
    F60["scripts/domergepr.sh"]
    F61["scripts/git-release.sh"]
    F62["scripts/install-tinygo.sh"]
    F63["scripts/large-file-hook.sh"]
    F64["scripts/linkmilestone.sh"]
    F65["scripts/pre-commit-hook.sh"]
    F66["scripts/rc.sh"]
    F67["scripts/reject_hidden_folders.sh"]
    F68["scripts/run-linters.sh"]
    F69["scripts/unlinkmilestone.sh"]
    F70["scripts/updateConfig.sh"]
    F1 --> F41
    F2 --> F41
    F3 --> F41
    F4 --> F41
